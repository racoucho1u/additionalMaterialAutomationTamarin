...
def parseAndRun(arg):
	...
	if (benchmarkCase == "smartverif"):
		...
		os.system(f"timeout 4h tamarin-prover --prove={lemma} {dirname}/{filename}.spthy {diff} +RTS -N4 -RTS --output={proofFile} --derivcheck-timeout=0 > {bigfile} 2>&1")
		end = perf_counter()
...
N = 5
file = "../../files_to_benchmark/input_lemmes.spthy"
